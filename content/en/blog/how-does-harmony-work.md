...
Vector representations of the [GAD-7](/compare-harmonise-instruments/gad-7-vs-phq-9/) and Beck's Anxiety InventoryCalculated using GPT-2Collapsed to three dimensions using t-SNE.
...
When Harmony receives two or more questionnaires, the text of each question is compared to each question in every other document. For example, [GAD-7](/compare-harmonise-instruments/gad-7-vs-sdq/) question 1 would be vectorised and compared to all of the questions in the PHQ-9, but not to any other questions in GAD-7.
