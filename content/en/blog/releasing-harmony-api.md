...
When the app is run, there is an [environment](https://fastdatascience.com/reduce-carbon-footprint-machine-learning) variable `HARMONY_DATA_PATH` which is set to `/data` on the production server, and that's where you need to put any data files. But you could set it to anything you like on your local machine e.g. `/home/xxx/data/` and put the files there and it will find them.
...
There are also other environment variables which tell the API where to look to load the sentence [transformer](https://harmonydata.ac.uk/how-does-harmony-work) or [contact](https://harmonydata.ac.uk/contact) Tika:

```
     environment:
       HARMONY_DATA_PATH: /data
       HARMONY_SENTENCE_TRANSFORMER_PATH: /data/paraphrase-[multilingual](https://fastdatascience.com/multilingual-natural-language-processing/)-MiniLM-L12-v2
...
curl -X 'POST' \
  ...
  -d '[
  {
    ...
    "file_name": "[GAD-7](https://adaa.org/sites/default/files/GAD-7_Anxiety-updated_0.pdf).pdf",
    "file_type": "pdf",
...
### [Matching](https://harmonydata.ac.uk/semantic-text-matching-with-deep-learning-transformer-models) instruments
...
## Alternative serverless [deployment](https://fastdatascience.com/machine-learning-model-deployment) on [AWS Lambda](https://aws.amazon.com/lambda/)
...
- [spaCy](https://spacy.io/) - Used for [NLP](https://fastdatascience.com/portfolio/nlp-consultant/) analysis
...
You can also cite the wider Harmony [project](https://fastdatascience.com/starting-a-data-science-project) which is registered with the Open Science Foundation:
