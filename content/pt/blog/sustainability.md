...
_Pergunta 3.1: Seu software está disponível como um pacote que pode ser implantado sem compilar?_ Construir software pode ser complicado e demorado. Fornecer seu software como um pacote que pode ser implantado sem compilar pode economizar tempo e esforço dos usuários para fazer isso sozinhos. Isso pode ser especialmente valioso se seus usuários não forem desenvolvedores de software. Você deve testar se o seu software compila e roda em todas as plataformas que ele pretende suportar, o que significa que você já terá criado pacotes que podem ser distribuídos aos seus usuários! Consulte nosso guia Pronto para lançamento? Uma lista de verificação para desenvolvedores (http://www.software.ac.uk/resources/guides/ready-release).
